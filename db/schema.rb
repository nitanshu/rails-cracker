...
ActiveRecord::Schema.define(version: 2020_01_20_145857) do
  ...
  create_table "paragraphs", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.integer "line"
    t.bigint "section_id"
    t.datetime "created_at", null: false
  ...
  create_table "solera_users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
